...
## なぜ注目か
Harness は Context 構築・Tool 選択・Planning・Memory・Validation・Recovery を束ねる「制御層」。7月は、**重みを凍結したまま足場を適応させて大幅改善**する手法が出そろう一方、**評価の厳密性・可監査性・帰属・安全**という"運用に耐えるための条件"が同時に問われ始めた。6月の [self-evolution 号](../jun_2026/self_evolution_trends.md) と合わせると、「改善ループ」全体が**統治の段階**へ入ったことが見える。
